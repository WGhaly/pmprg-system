...
export default function CreateDeliverableForm({ onSuccess }: CreateDeliverableFormProps) {
  ...
  const onSubmit = async (data: DeliverableFormData) => {
    try {
      ...
      alert(error instanceof Error ? error.message : 'Failed to create deliverable');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">Add New Deliverable</h2>
              <button
                onClick={handleClose}
